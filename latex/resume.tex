...
\item Designed and implemented workflow automation to greatly improve present operational process.
...
\cventry{Dec 2019}{\href{https://github.com/titaneric/AutoDiff-from-scratch/blob/master/Final\%20Presentation.ipynb}{Auto Differentiation}}{}{}{}{}
\cventry{May 2019}{\href{https://www.titaneric.com/buddy-system/}{Buddy System}}{}{}{}{}
\section{Projects}

\cventry{March 2023}{Court Reserveration Helper}{}{}{}{
\begin{itemize}
\item CLI program for court reservation in the concurrency way.
\item Capture HTTP packets from Wi-Fi (Mac with airport) and Android App.
\item Adopted in Rust embracing the beauty of multi-threading, safe, strong type.
\end{itemize}
}
...
\item Identify pod resource \& pod name by Kubelet pod resource \& client-go API
