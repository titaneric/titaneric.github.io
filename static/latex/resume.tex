...
\obj{Objective}
% seeking a position at the XXX in XXX Inc. where I can apply my skills of data wrangling, machine learning knowledge and data visualization.

%Dedicated software engineer, persistent learner and enthusiastic open source contributor. Strong in Python and experienced with large-scale software code reading and tracing (E.g., CPython, \href{https://github.com/pytorch/pytorch/pull/28651}{PyTorch} \& \href{https://titaneric.github.io/posts/buddy-system/}{Buddy System in Linux kernel}). %Seeking a position as a xxx engineer at xxx Inc, where I can apply my skills of web development, data science knowledge and modern software development experience.
\href{https://ti-user-certificates.s3.amazonaws.com/e0df7fbf-a057-42af-8a1f-590912be5460/ca820404-2858-41da-9d18-c3268d010348-huang-chen-yi-80c3b11d-2f72-4183-8271-9743fe40b47d-certificate.pdf}{Certified Kubernetes Administrator}, dedicated software engineer, persistent learner and enthusiastic open source contributor. Experienced building system and Kubernetes monitoring architecture, Kubernetes cluster administration, and large-scale software code reading and tracing. I'm honored to received the Arctic Code Vault Contributor at GitHub and give short talks about Kubernetes metrics at K8s summit in 2021.
...
\begin{itemize}
\item Built, enhanced, and promoted comprehensive monitoring and alerting architecture on \textbf{hundreds} of servers, scraping up to \textbf{8-10 GB} metrics per day.
\item Multi on-premise, total up to \textbf{40} nodes k8s clusters administration, migration experience in
\begin{itemize}
...
\item Share experience with colleagues, help investigated, and resolved the issues in Ansible playbook, system and network administration, observability, and Kubernetes.
