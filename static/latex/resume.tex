...
\begin{itemize}
\item Built, enhanced, and promoted comprehensive monitoring and alerting architecture on \textbf{hundreds} of servers, scraping up to \textbf{15 GB} metrics per day.
